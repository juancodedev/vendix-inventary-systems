        ...
        <div className="min-h-screen bg-slate-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                <h2 className="mt-6 text-center text-3xl font-extrabold text-slate-900 tracking-tight">
                    Inicia sesión en Vendix
                </h2>
                <p className="mt-2 text-center text-sm text-slate-600">
                    Bienvenido de nuevo. Accede a tu panel de control.
                </p>
            </div>
                ...
                <div className="bg-white py-8 px-4 shadow-xl border border-slate-100 sm:rounded-2xl sm:px-10">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-6">
                            <a
                                href="/signup"
                                className="w-full flex justify-center py-3 px-4 border border-slate-300 rounded-xl shadow-sm text-sm font-bold text-slate-700 bg-white hover:bg-slate-50 focus:outline-none transition-all text-center"
                            >
